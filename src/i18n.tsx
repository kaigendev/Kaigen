...
const english: Record<string, string> = {
  ...
  "PQ-запрос отклонён или отменён": "PQ request declined or cancelled",
  "Сообщение ожидает. Включите PQ вручную или продолжите без него.": "The message is waiting. Start PQ manually or continue without it.",
  "Собеседник отклонил PQ-запрос. Сообщение ожидает: включите PQ вручную или продолжите без него.": "The peer declined the PQ request. The message is waiting: start PQ manually or continue without it.",
  "PQ-запрос отменён. Сообщение ожидает: включите PQ вручную или продолжите без него.": "The PQ request was cancelled. The message is waiting: start PQ manually or continue without it.",
  "Сообщение сохранено и ждёт ответа клиента. После продолжения без PQ включить его автоматически уже нельзя.": "The message is saved and waiting for the client to reply. If you continue without PQ, it can no longer be enabled automatically.",
