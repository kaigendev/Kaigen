...
const english: Record<string, string> = {
  ...
  "Выберите режим подключения": "Choose a connection mode",
  "Выбор изменит только существующие сетевые настройки. Позже их можно настроить вручную.": "This choice only changes the existing network settings. You can adjust them manually later.",
  "Безопасный": "Safe",
  "Соединение через встроенный Tor с отключёнными прямыми сетевыми возможностями.": "Connect through built-in Tor with direct network capabilities disabled.",
  "Tor: включён": "Tor: on",
  "UDP: выключен": "UDP: off",
  "IPv6: выключен": "IPv6: off",
  "Локальные пиры: выключены": "Local peers: off",
  "Выбрать безопасный": "Choose Safe",
  "Быстрый": "Fast",
  "Прямое подключение без Tor с доступными быстрыми маршрутами и локальным обнаружением.": "Connect directly without Tor, with faster routes and local discovery available.",
  "Tor: выключен": "Tor: off",
  "UDP: включён": "UDP: on",
  "IPv6: включён": "IPv6: on",
  "Локальные пиры: включены": "Local peers: on",
  "Выбрать быстрый": "Choose Fast",
  "Применение…": "Applying…",
