...
const stableErrorMessages: Readonly<Record<string, LocalizedText>> = {
  ...
  TOX_ID_INVALID: { ru: "Tox ID должен содержать 76 шестнадцатеричных символов.", en: "The Tox ID must contain 76 hexadecimal characters." },
  TOX_ID_CHECKSUM_INVALID: { ru: "Tox ID не прошёл проверку контрольной суммы.", en: "The Tox ID checksum is invalid." },
  TOX_ID_NOSPAM_CHANGED: { ru: "У контакта изменился no-spam идентификатор; обновите Tox ID.", en: "The contact changed their no-spam value; refresh the Tox ID." },
  TOX_FRIEND_REQUEST_TOO_LONG: { ru: "Сообщение для авторизации слишком длинное.", en: "The authorization message is too long." },
  TOX_FRIEND_REQUEST_EMPTY: { ru: "Нужно указать сообщение для авторизации.", en: "An authorization message is required." },
  ...
  PROFILE_STATE_CHANGED: { ru: "Выбранный профиль изменился. Повторите действие для нужного профиля.", en: "The selected profile has changed. Repeat the action for the intended profile." },
